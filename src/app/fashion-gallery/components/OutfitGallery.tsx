...
export default function OutfitGallery({ filters }: OutfitGalleryProps) {
  ...
  const filteredOutfits = outfits.filter((outfit) => {
    ...
    filters.priceRange === 'all' || outfit.priceRange === filters.priceRange;
    return matchesOccasion && matchesPriceRange;
  });
